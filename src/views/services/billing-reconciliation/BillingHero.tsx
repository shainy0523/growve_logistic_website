      ...
      <Box className="landing-container pt-10! pb-5">
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: { xs: 6, md: 8 }, alignItems: 'center' }}>
          ...
          <ServiceHero
            ...
            title="Reconcile every rupee,"
            accent="automatically."
            description="Match every courier invoice and COD remittance against what you actually owe — catch overbilling, short-payments and late remittances before they cost you a paisa."
