                            ...
                            return (
                                <Box
                                    ...
                                    sx={{
                                        py: 2.5,
                                        cursor: 'pointer',
                                        // constant 2px border so activating doesn't shift layout;
                                        // only the colour animates for a smooth hover transition
                                        borderBottom: '2px solid',
                                        borderColor: isActive ? '#000' : '#EAEAEC',
                                ...
                                >
                                    ...
                                    <Collapse in={isActive} timeout={350} easing="ease-in-out">
                                        <Typography
                                            sx={{
                                                mt: 1,
                                                fontSize: '14px',
