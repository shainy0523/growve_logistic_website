...
function getPathImpl(object, path) {
    ...
    if (alternateProp && result === undefined) {
        ...
        const alternateKey = "".concat(alternateProp).concat(lastKey === 'default' ? '' : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$utils$2f$capitalize$2f$capitalize$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(lastKey));
...
function createUnaryUnit(theme, themeKey, defaultValue, propName) {
    var _getPath;
    const themeSpacing = (_getPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$style$2f$style$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPath"])(theme, themeKey, true)) !== null && _getPath !== void 0 ? _getPath : defaultValue;
...
function createSpacing() {
    ...
    transform = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$spacing$2f$spacing$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUnarySpacing"])({
...
function unstable_createStyleFunctionSx() {
    function styleFunctionSx(props) {
        ...
        const config = (_theme_unstable_sxConfig = theme.unstable_sxConfig) !== null && _theme_unstable_sxConfig !== void 0 ? _theme_unstable_sxConfig : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$styleFunctionSx$2f$defaultSxConfig$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
        ...
        function process(sxInput) {
            ...
            var _theme_breakpoints;
            const breakpoints = (_theme_breakpoints = theme.breakpoints) !== null && _theme_breakpoints !== void 0 ? _theme_breakpoints : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$breakpoints$2f$breakpoints$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_BREAKPOINTS"];
...
function generateUtilityClass(componentName, slot) {
    ...
    return globalStateClass ? "".concat(globalStatePrefix, "-").concat(globalStateClass) : "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$utils$2f$ClassNameGenerator$2f$ClassNameGenerator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].generate(componentName), "-").concat(slot);
}
...
function setColorChannel(obj, key) {
    if (!("".concat(key, "Channel") in obj)) {
        ...
        obj["".concat(key, "Channel")] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$colorManipulator$2f$colorManipulator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["private_safeColorChannel"])(toRgb(obj[key]), "MUI: Can't create `palette.".concat(key, "Channel` because `palette.").concat(key, "` is not one of these formats: #nnn, #nnnnnn, rgb(), rgba(), hsl(), hsla(), color().") + '\n' + "To suppress this warning, you need to explicitly provide the `palette.".concat(key, 'Channel` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.'));
    }
}
...
const createGetCssVar = function() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$cssVars$2f$createGetCssVar$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__unstable_createGetCssVar$3e$__["unstable_createGetCssVar"])(cssVarPrefix);
};
function attachColorScheme(colorSpace, colorSchemes, scheme, restTheme, colorScheme) {
    ...
    colorSchemes[colorScheme] = {
        ...
        overlays: (scheme === null || scheme === void 0 ? void 0 : scheme.overlays) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$styles$2f$createColorScheme$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOverlays"])(mode)
    };
    return muiTheme;
}
function createThemeWithVars() {
    ...
    Object.keys(theme.colorSchemes).forEach((key)=>{
        ...
        if (palette.mode === 'light') {
            ...
            setColor(palette.Skeleton, 'bg', colorSpace ? colorMix(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$colorManipulator$2f$colorManipulator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["private_safeAlpha"], nativeColor ? getCssVar('palette-text-primary') : palette.text.primary, 0.11) : "rgba(".concat(setCssVarColor('palette-text-primaryChannel'), " / 0.11)"));
        ...
        if (palette.mode === 'dark') {
            ...
            setColor(palette.Skeleton, 'bg', colorSpace ? colorMix(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$colorManipulator$2f$colorManipulator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["private_safeAlpha"], nativeColor ? getCssVar('palette-text-primary') : palette.text.primary, 0.13) : "rgba(".concat(setCssVarColor('palette-text-primaryChannel'), " / 0.13)"));
...
const splitProps = (props)=>{
    ...
    const config = (_props_theme_unstable_sxConfig = props === null || props === void 0 ? void 0 : (_props_theme = props.theme) === null || _props_theme === void 0 ? void 0 : _props_theme.unstable_sxConfig) !== null && _props_theme_unstable_sxConfig !== void 0 ? _props_theme_unstable_sxConfig : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$styleFunctionSx$2f$defaultSxConfig$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
...
const GlobalStyles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$zero$2d$styled$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["globalCss"])(isDynamicSupport ? (param)=>{
...
//# sourceMappingURL=node_modules_04b3e140._.js.map