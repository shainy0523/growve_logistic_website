...
function useRovingTabIndexRoot(params) {
    ...
    const registerItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$utils$2f$useEventCallback$2f$useEventCallback$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "useRovingTabIndexRoot.useEventCallback[registerItem]": (item)=>{
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$utils$2f$fastObjectShallowCompare$2f$fastObjectShallowCompare$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(previousItem !== null && previousItem !== void 0 ? previousItem : null, item)) {
                return;
            }
    ...
    const focusItem = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useRovingTabIndexRoot.useCallback[focusItem]": (currentIndex, direction, wrap, isItemFocusableOverride)=>{
            var _nextItem_element;
            const snapshot = getNavigableItemsSnapshot(itemMapRef.current);
            const nextItem = getNextActiveItem(snapshot, currentIndex, direction, wrap, isItemFocusableOverride !== null && isItemFocusableOverride !== void 0 ? isItemFocusableOverride : itemFilter);
            if (!nextItem) {
                return null;
            }
            (_nextItem_element = nextItem.element) === null || _nextItem_element === void 0 ? void 0 : _nextItem_element.focus();
    ...
    const focusNext = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "useRovingTabIndexRoot.useCallback[focusNext]": (isItemFocusableOverride)=>{
            ...
            var _focusItem_id;
            return (_focusItem_id = (_focusItem = focusItem(currentIndex, 'next', true, isItemFocusableOverride)) === null || _focusItem === void 0 ? void 0 : _focusItem.id) !== null && _focusItem_id !== void 0 ? _focusItem_id : null;
        }
...
function useRovingTabIndexItem(params) {
    ...
    const item = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "useRovingTabIndexItem.useMemo[item]": ()=>{
            var _params_disabled, _params_focusableWhenDisabled, _params_selected;
            return {
                disabled: (_params_disabled = params.disabled) !== null && _params_disabled !== void 0 ? _params_disabled : false,
                element: null,
                focusableWhenDisabled: (_params_focusableWhenDisabled = params.focusableWhenDisabled) !== null && _params_focusableWhenDisabled !== void 0 ? _params_focusableWhenDisabled : false,
                id: params.id,
                selected: (_params_selected = params.selected) !== null && _params_selected !== void 0 ? _params_selected : false,
 ...
 */ function resolveRequestedItemId(requestedItemId, items, isFocusable) {
    ...
    var _getNextActiveItem_id;
    return (_getNextActiveItem_id = (_getNextActiveItem = getNextActiveItem(items, requestedItemIndex, 'next', false, isFocusable)) === null || _getNextActiveItem === void 0 ? void 0 : _getNextActiveItem.id) !== null && _getNextActiveItem_id !== void 0 ? _getNextActiveItem_id : null;
}
/**
 ...
 */ function resolveDefaultItemId(items, isFocusable, getDefaultActiveItemId) {
    const defaultItemId = getDefaultActiveItemId === null || getDefaultActiveItemId === void 0 ? void 0 : getDefaultActiveItemId(items);
...
function getFirstFocusableItemId(items, isFocusable) {
    var _items_find;
    var _items_find_id;
    return (_items_find_id = (_items_find = items.find((item)=>isFocusable(item))) === null || _items_find === void 0 ? void 0 : _items_find.id) !== null && _items_find_id !== void 0 ? _items_find_id : null;
}
function getItemById(items, itemId) {
    var _items_find;
    return itemId == null ? null : (_items_find = items.find((item)=>item.id === itemId)) !== null && _items_find !== void 0 ? _items_find : null;
}
...
function findItemIndexByElement(items, element) {
    ...
    return items.findIndex((item)=>{
        var _item_element;
        return item.element === element || ((_item_element = item.element) === null || _item_element === void 0 ? void 0 : _item_element.contains(element));
    });
}
...
function getNextIndex(currentIndex, lastIndex, direction) {
    let wrap = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
    if (direction === 'next') {
...
/* eslint-enable no-bitwise */ function handleRefs() {
    ...
    return (node)=>{
        refs.forEach((ref)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$utils$2f$setRef$2f$setRef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(ref !== null && ref !== void 0 ? ref : null, node);
        });
    };
}
}),
...
//# sourceMappingURL=node_modules_baefdae3._.js.map